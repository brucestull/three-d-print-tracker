# Generated by Django 4.0 on 2022-10-02 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filament_instance', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='prints', to='prints.filamentinstance')),
            ],
        ),
        migrations.AddField(
